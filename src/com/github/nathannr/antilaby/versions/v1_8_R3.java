...
public class v1_8_R3 {
	...
	public static void setLabyModFeature(Player p, HashMap<EnumLabyModFeature, Boolean> list) {
		try {
			...
			net.minecraft.server.v1_8_R3.PacketDataSerializer b = new net.minecraft.server.v1_8_R3.PacketDataSerializer(a);
			net.minecraft.server.v1_8_R3.PacketPlayOutCustomPayload packet = new net.minecraft.server.v1_8_R3.PacketPlayOutCustomPayload("LABYMOD", b);
