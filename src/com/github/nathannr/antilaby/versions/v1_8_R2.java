...
public class v1_8_R2 {
	...
	public static void setLabyModFeature(Player p, HashMap<EnumLabyModFeature, Boolean> list) {
		try {
			...
			net.minecraft.server.v1_8_R2.PacketDataSerializer b = new net.minecraft.server.v1_8_R2.PacketDataSerializer(a);
			net.minecraft.server.v1_8_R2.PacketPlayOutCustomPayload packet = new net.minecraft.server.v1_8_R2.PacketPlayOutCustomPayload("LABYMOD", b);
