...
public class v1_10_R1 {
	...
	public static void setLabyModFeature(Player p, HashMap<EnumLabyModFeature, Boolean> list) {
		try {
			...
			net.minecraft.server.v1_10_R1.PacketDataSerializer b = new net.minecraft.server.v1_10_R1.PacketDataSerializer(a);
			net.minecraft.server.v1_10_R1.PacketPlayOutCustomPayload packet = new net.minecraft.server.v1_10_R1.PacketPlayOutCustomPayload("LABYMOD", b);
