...
public enum LabyModFeature {
  ...
  FOOD(true, 2), GUI(true, 2), NICK(true, 2), EXTRAS(true, 2), POTIONS(true, 2), ARMOR(true, 2), DAMAGEINDICATOR(true, 2), MINIMAP_RADAR(true, 2),

  // LabyMod 3 features
  BLOCKBUILD(false, 3), IMPROVED_LAVA(false, 3), CROSSHAIR_SYNC(false, 3), REFILL_FIX(false, 3), GUI_ALL(true, 3), GUI_POTION_EFFECTS(true, 3), GUI_ARMOR_HUD(true, 3), GUI_ITEM_HUD(true, 3),
