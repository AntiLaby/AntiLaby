...
public class BStats {
  ...
  private JSONObject getServerData() {
    ...
    try {
      ...
      playerAmount = onlinePlayersMethod.getReturnType().equals(Collection.class) ? ((Collection<?>) onlinePlayersMethod.invoke(Bukkit.getServer())).size() : ((Player[]) onlinePlayersMethod
  ...
  public static abstract class CustomChart {
    ...
    private JSONObject getRequestJsonObject() {
      ...
      try {
        ...
        if (data == null) // If the data is null we don't send the chart.
        {
          return null;
        }
        chart.put("data", data);
